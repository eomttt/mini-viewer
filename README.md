...
- **viewerPageCount** 변경됨에 따라서 **viewerIndexx**, **pageOffset** 를 변경시켜주어 그에 맞는 page 를 찾아서 viewer 와 슬라이더 카운트를 맞게 변경해준다.

> 그림에서 각각 **viewerIndexx** 는 **Spine Index** 로, **pageOffset** 는 **column count** 로 표현하였다.
